...
const LessonPlayer = () => {
  ...
  const correctFeedbacks = [
    ...
    "A lenda acerta de novo!",
    "Chutou? Nem parece, foi cirúrgico!",
    "Liso demais!",
    "O acerto veio como um raio!",
    "Mais uma pro currículo!",
    "Incrível sem esforço!",
    "Tá impossível hoje!",
  ];
  ...
  const incorrectFeedbacks = [
    ...
    "Calma calabreso!",
    "Já diria Dory: continue a nadar...",
    "Levanta, sacode a poeira e tenta de novo!",
    "A vida é feita de tentativas!",
    "Errar é humano, errar de novo é aprendizado!",
    "Foi quase! Tá no caminho.",
    "Tenta outra vez, vai que é tua!",
    "Não foi agora, mas vai ser já já!",
    "Errou? Relaxa, todo mundo erra!",
    "Foi por pouco, hein?",
    "Respira, inspira e tenta de novo.",
    "Você já tá aprendendo só de tentar!",
    "Deu ruim, mas nada que te pare!",
    "Chora não, bebê!",
    "Sabe de nada, inocente! Bora tentar de novo.",
    "Foi só pra aquecer!",
    "Foi bonito… só que não!",
    "Ai ai ai, que vacilo!",
  ];
