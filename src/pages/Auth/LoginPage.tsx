    ...
    <div className="min-h-screen bg-space-gradient flex flex-col items-center justify-center px-4 py-12">
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-white/80 mt-2">Sua jornada matemática pelo espaço</p>
        </div>
          ...
          <form onSubmit={handleLogin}>
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="text-right">
                  <Link to="/recuperar-senha" className="text-sm text-space-blue hover:underline">
                    Esqueceu a senha?
                  </Link>
                </div>
              </div>
            ...
            <CardFooter className="flex flex-col gap-4">
              ...
              <p className="text-sm text-center text-white/60">
                ...
                <Link to="/registrar" className="text-space-blue hover:underline">
                  Registre-se
                </Link>
              </p>
            </CardFooter>
